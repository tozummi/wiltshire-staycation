...
const JOURNEYS = {
  outbound: {
    ...
    anchors: {
      ...
      padArrive: "outbound-pad-arrive",
      padDepart: "outbound-pad-depart",
      end: "outbound-end"
    }
  },
  ...
  return: {
    ...
    anchors: {
      start: "return-start",
      padArrive: "return-pad-arrive",
      padDepart: "return-pad-depart",
      end: "return-end"
    }
  }
};
...
function calculateMarkerY(
  ...
  const startY =
    getAnchorY(
      track,
      journey.anchors.start
    );

  const padArriveY =
    getAnchorY(
      track,
      journey.anchors.padArrive
    );

  const padDepartY =
    getAnchorY(
      track,
      journey.anchors.padDepart
    );
  ...
  if (
    [startY, padArriveY, padDepartY, endY]
  ...
  /*
    During the station change the train remains
    visually parked at Paddington.
  */
